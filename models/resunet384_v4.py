...
class ResUNet384V4(nn.Module):
    def __init__(self):
        ...
        self.face_decoder1 = construct_decoder_layers(6, 128, 128, 2, add_spatial=True)
        self.face_decoder0 = construct_encoder_layers(6, 128, 128, 1, add_spatial=True) # This seems like an extra layer, no skip connection here
        
        self.fd_conv1 = construct_encoder_layers(6, 192, 64, 1) # 128 (deface1 from prev_decoder0) + 64 (face1) = 192
...
class FaceEnhancer(nn.Module):
    def __init__(self):
        super().__init__()
        self.gaussian_blur = GaussianBlur(kernel_size=(3, 3), sigma=1)
