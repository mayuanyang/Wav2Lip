...
class ProcessBlock384(nn.Module):
    def __init__(self, output_block_channels) -> None:
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2d(192, 192, kernel_size=3, stride=2, padding=1), # 6,6, 103+(5−1)×2=111
            Conv2d(192, 192, kernel_size=3, stride=1, padding=1, residual=True) # 115
            ), 

            nn.Sequential(Conv2d(192, 384, kernel_size=3, stride=2, padding=1), # 3,3, 115+(5−1)×2=123
            Conv2d(384, 384, kernel_size=3, stride=1, padding=1, residual=True), # 127
            ), 
