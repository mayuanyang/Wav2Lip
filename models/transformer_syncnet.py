...
class TransformerSyncnet(nn.Module):
    def __init__(self, num_heads, num_encoder_layers):
        ...
        self.face_encoder = nn.Sequential(
            ...
            Conv2d(30, 64, kernel_size=7, stride=1, padding=3), #192x192, 1+(7−1)×1=7
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True), #192x192, 1+(7−1)×1=7
            
            Conv2d(64, 64, kernel_size=7, stride=2, padding=3), #96x96, 7+(7−1)×2=7+12=19
            ...
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1), #6x6, 81+(3-1)x1=83
