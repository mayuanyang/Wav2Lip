...
class TransformerSyncnet(nn.Module):
    def __init__(self, num_heads, num_encoder_layers):
        ...
        self.face_encoder = nn.Sequential(
            ...
            Conv2d(256, 512, kernel_size=3, stride=(1, 2), padding=1), #94x47, 13
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True), #94x47, 15
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True), #94x47, 17

            Conv2d(512, 1024, kernel_size=3, stride=2, padding=1), # 47x24, 19
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True), # 47x24, 21

            Conv2d(1024, 512, kernel_size=3, stride=2, padding=1), # 24x 12, 25
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True), # 24x 12, 27
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True), # 24x 12, 29
            ...
            Conv2d(256, 128, kernel_size=3, stride=(2,1), padding=1), #6x6, 43
            ...
            Conv2d(128, 64, kernel_size=3, stride=1, padding=1), #6x6, 49
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True), #6x6, 51

            Conv2d(64, 64, kernel_size=3, stride=2, padding=1), #3x3, 53
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True), #3x3, 57
