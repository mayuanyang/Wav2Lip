...
class Wav2LipStep2(nn.Module):
    def __init__(self):
        super(Wav2LipStep2, self).__init__()

        self.face_encoder_blocks = nn.ModuleList([
            nn.Sequential(Conv2d(3, 16, kernel_size=7, stride=1, padding=3),
            ...
            nn.Sequential(Conv2d(32, 32, kernel_size=5, stride=2, padding=2), # 48,48
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True),
            ),
            ...
            nn.Sequential(Conv2d(64, 64, kernel_size=3, stride=2, padding=1),   # 12,12
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True)),

            nn.Sequential(Conv2d(64, 128, kernel_size=3, stride=2, padding=1),       # 6,6
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True)),

            nn.Sequential(Conv2d(128, 128, kernel_size=3, stride=2, padding=1),     # 3,3
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True),),
            
            nn.Sequential(Conv2d(128, 256, kernel_size=3, stride=1, padding=0),     # 1, 1
        ...
        self.face_decoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2dTranspose(1280, 768, kernel_size=3, stride=1, padding=0), # 3,3
            Conv2d(768, 768, kernel_size=3, stride=1, padding=1, residual=True),),

            nn.Sequential(Conv2dTranspose(896, 640, kernel_size=3, stride=2, padding=1, output_padding=1),
            ...
            nn.Sequential(Conv2dTranspose(576, 256, kernel_size=3, stride=2, padding=1, output_padding=1),
