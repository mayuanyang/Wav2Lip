...
class ResUNet384V5(nn.Module):
    def __init__(self, diffusion_steps=20):
        ...
        self.fe_down5 = construct_encoder_layers(2, 512, 512, 2)
        ...
        self.face_decoder5 = construct_decoder_layers(2, 512, 256, 2)
        self.fd_conv5 = construct_encoder_layers(2, 768, 256, 1) # 256 (deface5) + 512 (face5) = 768
    ...
    def _forward_single_step(self, audio_sequences, face_sequences, input_dim_size, B):
        # --- Audio encoding ---
    ...
    def forward(self, audio_sequences, face_sequences, step=None, train_face_enhancer=True):
        ...
        output = self._forward_single_step(audio_sequences, noisy_face_sequences, input_dim_size, B)
        return output, t0, None
